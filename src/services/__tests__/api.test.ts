...
describe('Listing Utilities', () => {
  ...
  describe('extractListingId', () => {
    it('should extract the listing ID from a valid URL', () => {
      const url = "https://www.withgarage.com/listing/2003-Ford-F550-Rescue-fdd3f8c6-5d79-4dac-af01-48bb0a1e61f9";
      expect(extractListingId(url)).toBe("fdd3f8c6-5d79-4dac-af01-48bb0a1e61f9");
    });
  ...
  describe('fetchListing', () => {
    it('should fetch listing data for a valid URL', async () => {
      ...
      mock.onPost(`${API_BASE_URL}/getListing`, { id: "fdd3f8c6-5d79-4dac-af01-48bb0a1e61f9" }).reply(200, {
    ...
    it('should throw an error if the fetch fails', async () => {
      ...
      mock.onPost(`${API_BASE_URL}/getListing`, { id: "201-48bb0a1e61f9" }).reply(500);
